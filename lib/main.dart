        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: () {
              if (GetUtils.isNum(_editingController.text)){
                Get.snackbar("正确", "是数字",backgroundColor: Colors.greenAccent);
              }else{
                Get.snackbar("错误", "请输入正确的数组", backgroundColor: Colors.pink);
              }
            }, child: const Text('是否为空')),
            ElevatedButton(
                onPressed: () {
